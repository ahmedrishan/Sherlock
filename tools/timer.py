...
def set_timer(seconds: int | str) -> str:
    """Sets a background countdown timer for a specified number of seconds.

    Args:
        seconds (int | str): Time in seconds before the timer expires.
